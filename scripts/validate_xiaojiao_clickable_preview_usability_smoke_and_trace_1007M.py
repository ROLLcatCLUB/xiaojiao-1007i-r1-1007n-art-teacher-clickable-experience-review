...
SLUG="xiaojiao_clickable_preview_usability_smoke_and_trace_1007M"
EXPECTED_STATUS="XIAOJIAO_CLICKABLE_PREVIEW_USABILITY_SMOKE_AND_TRACE_PASS"
EXPECTED_MARKER="ALL_1007M_CLICKABLE_PREVIEW_USABILITY_SMOKE_AND_TRACE_CHECKS_OK"
REQUIRED_FILES=["docs/foundation/xiaojiao_clickable_preview_usability_smoke_and_trace_1007M.md", "docs/foundation/xiaojiao_clickable_preview_usability_smoke_and_trace_1007M.json", "samples/xiaojiao_clickable_preview_usability_smoke_and_trace_1007M/clickable_preview_smoke_trace_1007M.json", "docs/audit/xiaojiao_clickable_preview_usability_smoke_and_trace_1007M_result.json", "docs/audit/xiaojiao_clickable_preview_usability_smoke_and_trace_1007M_report.md", "scripts/validate_xiaojiao_clickable_preview_usability_smoke_and_trace_1007M.py", "docs/audit_packages/xiaojiao_clickable_preview_usability_smoke_and_trace_1007M_manifest.json", "docs/audit_packages/xiaojiao_clickable_preview_usability_smoke_and_trace_1007M.zip"]
...
def main():
 ...
 for term in ["XIAOJIAO_CLICKABLE_PREVIEW_USABILITY_SMOKE_AND_TRACE_PASS", "teacher_review_required", "formal_apply_performed=false", "smoke_checklist"]:
