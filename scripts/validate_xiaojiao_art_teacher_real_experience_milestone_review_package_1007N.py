...
SLUG="xiaojiao_art_teacher_real_experience_milestone_review_package_1007N"
EXPECTED_STATUS="XIAOJIAO_ART_TEACHER_REAL_EXPERIENCE_MILESTONE_REVIEW_PACKAGE_PASS"
EXPECTED_MARKER="ALL_1007N_ART_TEACHER_REAL_EXPERIENCE_MILESTONE_REVIEW_PACKAGE_CHECKS_OK"
REQUIRED_FILES=["docs/foundation/xiaojiao_art_teacher_real_experience_milestone_review_package_1007N.md", "docs/foundation/xiaojiao_art_teacher_real_experience_milestone_review_package_1007N.json", "samples/xiaojiao_art_teacher_real_experience_milestone_review_package_1007N/real_experience_milestone_1007N.json", "docs/audit/xiaojiao_art_teacher_real_experience_milestone_review_package_1007N_result.json", "docs/audit/xiaojiao_art_teacher_real_experience_milestone_review_package_1007N_report.md", "scripts/validate_xiaojiao_art_teacher_real_experience_milestone_review_package_1007N.py", "docs/audit_packages/xiaojiao_art_teacher_real_experience_milestone_review_package_1007N_manifest.json", "docs/audit_packages/xiaojiao_art_teacher_real_experience_milestone_review_package_1007N.zip"]
...
def main():
 ...
 for term in ["XIAOJIAO_ART_TEACHER_REAL_EXPERIENCE_MILESTONE_REVIEW_PACKAGE_PASS", "teacher_review_required", "what_user_can_experience", "what_is_not_real_yet", "1008A_PROVIDER_SANDBOX_PLANNING"]:
