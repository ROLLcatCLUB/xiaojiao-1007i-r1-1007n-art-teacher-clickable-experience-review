...
SLUG="xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K"
EXPECTED_STATUS="XIAOJIAO_ART_TEACHER_CLICKABLE_PREVIEW_WITH_INTENT_BAR_PASS"
EXPECTED_MARKER="ALL_1007K_ART_TEACHER_CLICKABLE_PREVIEW_WITH_INTENT_BAR_CHECKS_OK"
REQUIRED_FILES=["docs/foundation/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K.md", "docs/foundation/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K.json", "samples/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K/index.html", "samples/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K/preview_state_1007K.json", "samples/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K/preview_events_1007K.json", "samples/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K/intent_bar_trace_1007K.json", "docs/audit/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K_result.json", "docs/audit/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K_report.md", "scripts/validate_xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K.py", "docs/audit_packages/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K_manifest.json", "docs/audit_packages/xiaojiao_art_teacher_clickable_preview_with_intent_bar_1007K.zip"]
...
def main():
 ...
 for term in ["XIAOJIAO_ART_TEACHER_CLICKABLE_PREVIEW_WITH_INTENT_BAR_PASS", "teacher_review_required", "对小教说一句", "探究短一点", "重新设计这节课", "semantic_confirmation", "teacher_review_gate"]:
