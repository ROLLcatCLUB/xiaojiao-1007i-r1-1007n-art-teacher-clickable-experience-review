...
EXPECTED_STATUS="XIAOJIAO_ART_TEACHER_PRODUCT_EXPERIENCE_DENOISE_POLISH_PASS"
EXPECTED_MARKER="ALL_1007O_R1_ART_TEACHER_PRODUCT_EXPERIENCE_DENOISE_POLISH_CHECKS_OK"
REQUIRED_FILES=[
 "docs/foundation/xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1.md",
 "docs/foundation/xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1.json",
 "samples/xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1/index.html",
 "samples/xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1/denoise_notes_1007O_R1.json",
 "samples/xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1/experience_trace_1007O_R1.json",
 "docs/audit/xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1_result.json",
 "docs/audit/xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1_report.md",
 "scripts/validate_xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1.py",
 "docs/audit_packages/xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1_manifest.json",
 "docs/audit_packages/xiaojiao_art_teacher_product_experience_denoise_polish_1007O_R1.zip",
]
