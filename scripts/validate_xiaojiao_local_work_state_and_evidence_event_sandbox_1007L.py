...
SLUG="xiaojiao_local_work_state_and_evidence_event_sandbox_1007L"
EXPECTED_STATUS="XIAOJIAO_LOCAL_WORK_STATE_AND_EVIDENCE_EVENT_SANDBOX_PASS"
EXPECTED_MARKER="ALL_1007L_LOCAL_WORK_STATE_AND_EVIDENCE_EVENT_SANDBOX_CHECKS_OK"
REQUIRED_FILES=["docs/foundation/xiaojiao_local_work_state_and_evidence_event_sandbox_1007L.md", "docs/foundation/xiaojiao_local_work_state_and_evidence_event_sandbox_1007L.json", "samples/xiaojiao_local_work_state_and_evidence_event_sandbox_1007L/local_work_state_1007L.json", "samples/xiaojiao_local_work_state_and_evidence_event_sandbox_1007L/event_log_1007L.json", "samples/xiaojiao_local_work_state_and_evidence_event_sandbox_1007L/evidence_events_1007L.json", "docs/audit/xiaojiao_local_work_state_and_evidence_event_sandbox_1007L_result.json", "docs/audit/xiaojiao_local_work_state_and_evidence_event_sandbox_1007L_report.md", "scripts/validate_xiaojiao_local_work_state_and_evidence_event_sandbox_1007L.py", "docs/audit_packages/xiaojiao_local_work_state_and_evidence_event_sandbox_1007L_manifest.json", "docs/audit_packages/xiaojiao_local_work_state_and_evidence_event_sandbox_1007L.zip"]
...
def main():
 ...
 for term in ["XIAOJIAO_LOCAL_WORK_STATE_AND_EVIDENCE_EVENT_SANDBOX_PASS", "teacher_review_required", "privacy_level", "exportable_candidate", "teacher_quick_mark"]:
