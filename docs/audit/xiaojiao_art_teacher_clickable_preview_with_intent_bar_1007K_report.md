...
marker=ALL_1007K_ART_TEACHER_CLICKABLE_PREVIEW_WITH_INTENT_BAR_CHECKS_OK
```

Preview-only evidence generated for 1007K. No real provider, database, memory, Feishu, frontend runtime, or formal apply.
